...
//        val reportIssueItem = popupView.findViewById<TextView>(R.id.assistant_text_report)
        val readItem = popupView.findViewById<TextView>(R.id.assistant_text_read)
        val readStopItem = popupView.findViewById<TextView>(R.id.assistant_text_read_stop)
//
...
//        }
        ...
        readItem.setOnClickListener { v: View? ->
            onClickListener.onClick(v)
            popupWindow.dismiss()
        }
        readStopItem.setOnClickListener { v: View? ->
            onClickListener.onClick(v)
            popupWindow.dismiss()
        }
//
